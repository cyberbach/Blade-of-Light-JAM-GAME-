...
set FBX_FOLDER="D:\Projects\Blade-of-Light\fbx"
set G3DB_FILES="*.g3db"
set G3DB_LEVEL_FILES="level_*.g3db"
set ASSETS_DIR="D:\Projects\Blade-of-Light\android\assets\models"
set WORLD_DIR="D:\Projects\Blade-of-Light\android\assets\models\world"
